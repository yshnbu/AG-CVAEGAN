...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='test', help='folder | cifar10 | mnist ')
        ...
        self.parser.add_argument('--model', type=str, default='AG_CVAEGAN', help='chooses which model to use')
        ...
        self.parser.add_argument('--num_classes', type=int, default=6, help='For cvae clusters')
